        ...
        return (
            <article>
                ...
                <div className='textcontainer'>
                    <button disabled={this.state.disabled} onClick={e => this.handleOpen(this.props.id)} className='opencapsule' id={this.props.title + '_button'}>{this.state.clock}{this.state.status}</button>
                    </div>
                    <div className='textcontainer'>
